...
def main():
    ...
    ap.add_argument("--temporal",    action="store_true", help="Use temporal split (chronological) instead of random split.")
    args = ap.parse_args()
    ...
    t0 = time.time()
    train_cases, val_cases, _ = load_case_split_from_csv(args.csv, args.train_ratio, args.seed, temporal=args.temporal)
